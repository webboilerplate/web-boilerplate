...
// The actual regexps go on Semver.re
var re = Semver.re = [];
var src = Semver.src = [];
var R = 0;
...
Semver.compareIdentifiers = compareIdentifiers;
...
Semver.rcompareIdentifiers = rcompareIdentifiers;
...
Semver.compareLoose = compareLoose;
function compareLoose(a, b) {
  return compare(a, b, true);
}

Semver.rcompare = rcompare;
...
function rsort(list, loose) {
  return list.sort(function(a, b) {
    return Semver.rcompare(a, b, loose);
  });
}
...
Semver.toComparators = toComparators;
...
Semver.maxSatisfying = maxSatisfying;
...
var localHashPath = __dirname + '../.package.sha1';
